...
import (
	...
	infrastructurev1alpha1 "github.com/andfasano/cluster-api-provider-libvirt/api/v1alpha1"
	"github.com/andfasano/cluster-api-provider-libvirt/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "db54c2d8.cluster.x-k8s.io",
